/**
 * Created by mingxuan on 16/3/29.
 */
 ...
 */
def loadWordCountFromFile(filePath:String):RDD[(String, Int)]={
...
def loadTextFileAsWordCount(filePath:String,numberOfChar:Int):RDD[(String,Int)]={
...
def loadCountsWithIKAnalyzer(filePath:String):RDD[(String,Int)]={
  val inputFile = sc.textFile(filePath);
...
def loadWithIKAnalyzer(filePath:String):RDD[(String)]={
  val inputFile = sc.textFile(filePath);
...
def loadWithIKAnalyzerFromLocalSample():RDD[(String)]={

  return loadWithIKAnalyzer("file:///Users/mingxuan/Desktop/workspace/bigdatasource/wiki/AA/wiki_00.txt");
}



def loadS3SampleAsWordCount(numberOfChar:Int):RDD[(String,Int)]={

  return loadTextFileAsWordCount("s3n://wiki.bigdata.sig.damondeng.com/simplified/AA/wiki_00.txt",numberOfChar);
}


def loadLocalSampleAsWordCount(numberOfChar:Int):RDD[(String,Int)]={

  return loadTextFileAsWordCount("file:///Users/mingxuan/Desktop/workspace/bigdatasource/wiki/AA/wiki_00.txt",numberOfChar);
}
...
def loadWordPossibilityFromFile(filePath:String):RDD[(String,Float)]={

  val counts1 = loadTextFileAsWordCount(filePath,1)
  val counts2 = loadTextFileAsWordCount(filePath,2)

  return calculateWordPossibility(counts1,counts2)
}



def loadWordPossibilityFromLocalSampleFile():RDD[(String,Float)]={

  return loadWordPossibilityFromFile("file:///Users/mingxuan/Desktop/workspace/bigdatasource/wiki/AA/wiki_00.txt");
...
def calculateWordPossibilityIter(counts1:RDD[(String,Int)],counts2:RDD[(String,Float)],counts3:RDD[(String,Int)]):RDD[(String,Float)]={
  ...
  return back_to_counts2_possibility;

}

def loadWordPossibilityIterFromFile(filePath:String):RDD[(String,Float)]={

  val counts1 = loadTextFileAsWordCount(filePath,1)
  val counts2 = loadTextFileAsWordCount(filePath,2)
  val counts3 = loadTextFileAsWordCount(filePath,3)

  val counts2_possibility=calculateWordPossibility(counts1,counts2)

  return calculateWordPossibilityIter(counts1,counts2_possibility,counts3)
}

def loadTextFileAsWordCountFromLocalSampleFile(number:Int): RDD[(String, Int)] ={

  return loadTextFileAsWordCount("file:///Users/mingxuan/Desktop/workspace/bigdatasource/wiki/AA/wiki_00.txt",number)
}


def loadWordPossibilityIterFromLocalSampleFile():RDD[(String,Float)]={

  return loadWordPossibilityIterFromFile("file:///Users/mingxuan/Desktop/workspace/bigdatasource/wiki/AA/wiki_00.txt");

}


def loadWordPossibilityFromS3SampleFile():RDD[(String, Float)]={

  return loadWordPossibilityFromFile("s3n://wiki.bigdata.sig.damondeng.com/simplified/AA/wiki_00.txt");

}

def loadWordPossibilityFromS3():RDD[(String,Float)]={
  return loadWordPossibilityFromFile("s3n://wiki.bigdata.sig.damondeng.com/simplified/");
...
println("wiki operation module loaded.");
